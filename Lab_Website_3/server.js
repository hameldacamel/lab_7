...
app.get('/team_stats', function(req, res) {
	var win_query = 'select count(*) as Wins from football_games where home_score > visitor_score;'
	var lose_query = 'select count(*) as Losses from football_games where home_score < visitor_score;'
	var gen_query = 'select * from football_games;'
	db.task('get-everything', task => {
    return task.batch([
        task.any(gen_query),
        task.any(lose_query),
...
app.get('/player_info/post', function(req, res) {
	...
	var player = "select * from football_players where'" + playerID + "= id';"; 
	var player_games="select count(*) from football_games where'" + playerID +  "= any(players)';";
	db.task('get-everything', task => {
        return task.batch([
            task.any(name_id),
            task.any(player),
